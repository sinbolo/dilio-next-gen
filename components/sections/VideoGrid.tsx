  ...
  return (
    <section ref={sectionRef} id="section-video" className="min-h-screen relative flex items-center justify-center bg-black text-white py-[120px] overflow-hidden">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 relative z-10 flex flex-col gap-12 items-center">
        ...
        <div 
          className="relative w-full max-w-[1200px] aspect-[9/45] md:aspect-[16/10] bg-[#1a1a1a] rounded-[2rem] md:rounded-[3rem] p-3 md:p-[22px] shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_30px_60px_rgba(0,0,0,0.8),inset_0_0_0_2px_#333,inset_0_0_20px_rgba(0,0,0,1)] ring-1 ring-black"
        >
